...
for eval_noise_level in range (0, 201, 25):
    for i in range(1,10):
        ...
        hist_filename = './histories/noise-{}/layer-{}.txt'.format(eval_noise_level, i)
...
for i in range(1,10):
    ...
    hist_filename = './histories/trainable/layer-{}.txt'.format(i)
...
with open(pathlib.Path('histories/default/default.txt'), 'r') as default_model_history_file:
...
for i in range(0,9):
    ...
    for noise_level in  range(0, 201, 25):
        file_loc = pathlib.Path('histories/noise-{}/layer-{}.txt'.format(noise_level, index))
...
# training experiment
for i in range(1,10):
    file_loc = pathlib.Path('histories/trainable/layer-{}.txt'.format(i))
